...
module Symm32
  describe Family do
    ...
    it "classifies tetragonal families appropriately" do
      ...
      dir2 = Direction.new(Axis::T90, [ISO2] of SymmBase::Isometry)
    ...
    it "classifies hexagonal families appropriately" do
      dir1 = Direction.new(Axis::Z, [ISO1, ISO4] of SymmBase::Isometry)
      dir2 = Direction.new(Axis::T90, [ISO2] of SymmBase::Isometry)
      dir1.classification.should eq AxisKind::None
    ...
    it "classifies cubic families appropriately" do
      dir1 = Direction.new(Axis::Z, [ISO1, ISO4] of SymmBase::Isometry)
      dir3 = Direction.new(Axis::D1, [ISO5] of SymmBase::Isometry)
      dir1.classification.should eq AxisKind::None
