module Symmetry
  ...
  class Rotation < PointIsometry
    ...
    # instead of giving the angle, you can give "n-fold" axis and number of times
    # to apply so 3-fold = 120 degrees, 3-fold^2 = 240 degrees
